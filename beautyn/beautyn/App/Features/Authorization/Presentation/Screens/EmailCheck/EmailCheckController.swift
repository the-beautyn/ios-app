...
// MARK: - EmailCheckController

final class EmailCheckController: BaseHostingViewController<EmailCheckViewModel, EmailCheckView> {

    init(viewModel: EmailCheckViewModel) {
