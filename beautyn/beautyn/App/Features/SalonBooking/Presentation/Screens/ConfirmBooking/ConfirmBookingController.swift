...
// MARK: - ConfirmBookingController

final class ConfirmBookingController: BaseHostingViewController<ConfirmBookingViewModel, ConfirmBookingView> {

    init(viewModel: ConfirmBookingViewModel) {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        navigationItem.title = Localization.confirmBookingTitle
    ...
    // the Figma navigation title, same as SelectDateTime.
