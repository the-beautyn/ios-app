...
public enum Localization {
  ...
  public static let bookingClearButton = Localization.tr("Localizable", "booking_clear_button", fallback: "Очистити")
  ...
  public static let bookingDetailsAddToCalendar = Localization.tr("Localizable", "booking_details_add_to_calendar", fallback: "Додати в календар")
  public static let bookingDetailsBookAgain = Localization.tr("Localizable", "booking_details_book_again", fallback: "Забронювати знову")
  public static let bookingDetailsCalendarAccessDenied = Localization.tr("Localizable", "booking_details_calendar_access_denied", fallback: "Дозвольте доступ до календаря в Налаштуваннях.")
  ...
  public static let bookingDetailsMakeChanges = Localization.tr("Localizable", "booking_details_make_changes", fallback: "Внести зміни")
  public static let bookingDetailsMakeChangesSubtitle = Localization.tr("Localizable", "booking_details_make_changes_subtitle", fallback: "Перенести, відредагувати, відмінити.")
  public static let bookingDetailsRoute = Localization.tr("Localizable", "booking_details_route", fallback: "Прокласти маршрут")
  public static let bookingDetailsServicesSection = Localization.tr("Localizable", "booking_details_services_section", fallback: "Деталі запису")
  public static let bookingDetailsStatusCancelled = Localization.tr("Localizable", "booking_details_status_cancelled", fallback: "Скасовано")
  public static let bookingDetailsStatusCompleted = Localization.tr("Localizable", "booking_details_status_completed", fallback: "Завершено")
  public static let bookingDetailsStatusConfirmed = Localization.tr("Localizable", "booking_details_status_confirmed", fallback: "Підтверджено")
  public static let bookingDetailsTitle = Localization.tr("Localizable", "booking_details_title", fallback: "Деталі бронювання")
  public static let bookingDetailsTotal = Localization.tr("Localizable", "booking_details_total", fallback: "Всього")
  ...
  public static let searchFilterApply = Localization.tr("Localizable", "search_filter_apply", fallback: "Застосувати")
  public static let searchFilterCategoryTitle = Localization.tr("Localizable", "search_filter_category_title", fallback: "Категорія послуги")
  public static let searchFilterClear = Localization.tr("Localizable", "search_filter_clear", fallback: "Очистити")
